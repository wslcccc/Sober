...
ENCODER_PATH = '/home/test/xulei/CoGNNs_LLMMH/save_models_and_data'
...
def get_data_list():
    ...
    if FLAGS.force_regen:
        ...
        save(init_feat_dict, join('/home/test/xulei/CoGNNs_LLMMH/save_models_and_data', 'pragma_dim'))
