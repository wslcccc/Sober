...
def inference(dataset):
    ...
    test_loader = DataLoader(li[0], batch_size=FLAGS.batch_size, pin_memory=True)  # TODO
    ...
    for epoch in epochs:
        ...
        if loss <= min_loss:
            torch.save(model.state_dict(),
                           '/home/test/xulei/CoGNNs_LLMMH/save_models_and_data/regression_model_state_dict.pth')
